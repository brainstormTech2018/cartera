      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Certificados</a>
          </div>
            ...
            <div class="card-footer ">
                ...
                <div class="stats">
                 <div class="row">
                  <div class="ml-auto">
                    <div class="stats">
                      <a href="../control/reportes/inventario.php">Descargar</a>
                    </div>
                  </div>
                </div>
                </div>
            ...
            <div class="card-footer ">
                ...
                <div class="stats">
                 <div class="row">
                  <div class="ml-auto">
                    <div class="stats">
                      <a href="../control/reportes/cartera_del_mes.php">Descargar</a>
                    </div>
                  </div>
                </div>
                </div>
            ...
            <div class="card-footer ">
                ...
                <div class="stats">
                 <div class="row">
                  <div class="ml-auto">
                    <div class="stats">
                      <a href="../control/reportes/ventas_del_mes.php">Descargar</a>
                    </div>
                  </div>
                </div>
                </div>
          ...
          <div class="card ">
            ...
            <div class="card-footer ">
                ...
                <div class="row">
                  <div class="ml-auto">
                    <div class="stats">
                      <a href="../control/reportes/comparativos.php">Descargar</a>
                    </div>
                  </div>
                </div>
              </div>
