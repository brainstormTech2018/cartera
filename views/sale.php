...
$sql = "SELECT conf_consecutivo FROM mcm_settings";

$resultado = $link->query($sql);
$consecutivo = '';
if($settings = $resultado->fetch_assoc()){
  $consecutivo = $settings['conf_consecutivo'];
}else{
  $consecutivo = 'error';
}
?>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">SOLICITUD DE CREDITO <?php echo $consecutivo  ?></a>
          </div>
              ...
              <div class="input-group no-border">
                ...
                <div class="input-group-append">
                  <div class="input-group-text">
                    <a onclick="cargarCliente();" href=""><i class="nc-icon nc-zoom-split"></i></a>
                  </div>
                </div>
              </div>
            </form>
                  ...
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label>Nombre</label>
                        <input type="text" class="form-control" placeholder="Nombre" id="nombre" name="nombre" disabled>
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label>Apellido</label>
                        <input type="text" class="form-control" placeholder="Apellido" id="apellido" name="apellido" disabled> 
                      </div>
                    </div>
                ...
                <div class="row">
                      <div class="col-md-6">
                        <div class="card ">
                          ...
                          <div class="card-body ">
                            <div class="form-group">
                              <label>Precio de la lista</label>
                              <input type="text" class="form-control" placeholder="#" id="apellido" name="apellido"> 
                            </div>
                            <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <div class="card ">
                          <div class="card-header ">
                            <h5 class="card-title">Dineros en deposito</h5>
                          </div>
                           <div class="card-body">
                            <div class="row">
                               <div class="col-md-4">
                                <div class="form-group">
                                    <label>Fecha</label>
                                    <input type="text" class="form-control" placeholder="12/18/2018" id="fecha" name="fecha"> 
                                  </div>
                               </div>
                               <div class="col-md-4">
                                <label>Recibo</label>
                                    <input type="text" class="form-control" placeholder="#" id="recibo" name="recibo"> 
                               </div>
                               <div class="col-md-4">
                                <label>Valor</label>
